        ...
        >
          ...
          <div className="prose prose-gray max-w-none space-y-8 text-gray-600 leading-relaxed">
            ...
            <section>
              ...
              <p>Vi lagrar dina uppgifter så länge det är nödvändigt för att fullgöra ändamålet, normalt upp till 24 månader från senaste kontakttillfälle, varefter de raderas.</p>
            </section>

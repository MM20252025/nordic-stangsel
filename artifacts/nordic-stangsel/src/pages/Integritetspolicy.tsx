...
export default function Integritetspolicy() {
  ...
  const sections = isSv
    ? [
        { title: "1. Personuppgiftsansvarig", body: "Nordic Stängsel AB, org.nr 559582-1900, Vårsångsvägen 4, 741 43 Knivsta, är personuppgiftsansvarig för behandlingen av dina personuppgifter." },
    ...
    : [
        { title: "1. Data controller", body: "Nordic Stängsel AB, company registration number 559582-1900, Vårsångsvägen 4, 741 43 Knivsta, is the data controller for the processing of your personal data." },
          ...
          <div className="prose prose-gray max-w-none space-y-8 leading-relaxed text-gray-600">
            ...
            <section>
              ...
              <p>
                ...
                Vårsångsvägen 4, 741 43 Knivsta<br />
